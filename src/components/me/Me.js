...
<div className={styles.subtitle}>"רק עבודה חכמה,יעילה והתמדה תביא אותך לתוצאות שאת חולמת עליהן"</div>
        <p className={styles.description}>אני מעיין, מניקוריסטית מעל ל-8 שנים ומכשירה מניקורסטיות בשנתיים האחרונות</p>
        ...
        <p className={styles.description} style={{fontWeight:700}}>עד שלקחתי קורס דיגיטלי בעצמי ששינה עבורי את ההסתכלות על הנושא</p>
